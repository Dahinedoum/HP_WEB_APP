            ...
            <FooterContent>
              ...
              {isCharacter && (
                <ButtonContainer>
                  ...
                  <Button onClick={handleGoToEditCharacterForm}><FaPen /></Button>
                  <Button onClick={() => onRemove(character.id)}><FaTrashAlt /></Button>
                </ButtonContainer>
              )}
              {isStaff && (
                <ButtonContainer>
                  ...
                  <Button onClick={handleGoToEditStaffForm}><FaPen /></Button>
                  <Button onClick={() => onRemove(character.id)}><FaTrashAlt /></Button>
                </ButtonContainer>
              )}
              {isStudent && (
                <ButtonContainer>
                  ...
                  <Button onClick={handleGoToEditStudentForm}><FaPen /></Button>
                  <Button onClick={() => onRemove(character.id)}><FaTrashAlt /></Button>
                </ButtonContainer>
              )}
            </FooterContent>
